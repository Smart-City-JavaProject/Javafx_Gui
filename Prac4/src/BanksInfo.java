...
public class BanksInfo {
    ...
    public static void initialize() {
        ...
        TableView<Bank_Infos> table = new TableView<Bank_Infos>();
        final ObservableList<Bank_Infos> data = FXCollections.observableArrayList();
        ...
        try {
            ...
            for (int i = 0; i < lines.length; i++) {
                ...
                data.add(new Bank_Infos(labels, label12, bt));
    ...
    public static class Bank_Infos {

        private Label firstName;
        private Label lastName;
        private Button email;

        private Bank_Infos(Label fName, Label lName, Button email) {
