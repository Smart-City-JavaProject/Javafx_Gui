...
public class PoliceInfo {
    ...
    public static void initialize() {
        ...
        TableView<Police_Infos> table = new TableView<Police_Infos>();
        final ObservableList<Police_Infos> data = FXCollections.observableArrayList();
        ...
        firstNameCol.setCellValueFactory(
                new PropertyValueFactory<Police_Infos, Label>("firstName"));
        TableColumn lastNameCol = new TableColumn("Sector");
        lastNameCol.setMinWidth(180);
        lastNameCol.setCellValueFactory(
                new PropertyValueFactory<Police_Infos, Label>("lastName"));

        TableColumn emailCol = new TableColumn("More Info");
        emailCol.setMinWidth(300);
        emailCol.setCellValueFactory(
                new PropertyValueFactory<Police_Infos, Button>("email"));
        try {
            stage.setTitle("Smart City");
            VBox vbox = new VBox();
            for (int i = 0; i < lines.length; i++) {
                ...
                data.add(new Police_Infos(labels, label12, bt));
    ...
    public static class Police_Infos {
        ...
        private Police_Infos(Label fName, Label lName, Button email) {
