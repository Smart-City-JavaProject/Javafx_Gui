...
public class TrainInfo {
    ...
    public static void initialize() {
        ...
        TableView<Train_Infos> table = new TableView<Train_Infos>();
        final ObservableList<Train_Infos> data = FXCollections.observableArrayList();
        ...
        try {
            ...
            for (int i = 0; i < lines.length; i++) {
                ...
                data.add(new Train_Infos(labels, label2, bt));
                final int t1 = i;
    ...
    public static class Train_Infos {

        private Label firstName;
        private Label lastName;
        private Button email;

        private Train_Infos(Label fName, Label lName, Button email) {
